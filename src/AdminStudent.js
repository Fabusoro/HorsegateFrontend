        ...
        <div className="div-container">
            ...
            <div className="information-bar">
                ...
                <div className="table-container">
                    ...
                    <button className="table-add-button"><Link to={'/register-student'} style={{ textDecoration: 'none' }}><p className="add-button-label">Add Student</p></Link></button>
                        ...
                        <tbody className="table-body">
                            {students.map(item =>
                            {
                                ...
                                return <tr key={item.id}>
                                    ...
                                    <td ><Link to={`/students/${item.id}`} style={{ textDecoration: 'none' }}><button className="table-edit-button">Edit</button></Link></td>
